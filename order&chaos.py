...
"""
An implementation of Minimax AI Algorithm in Order and Chaos,
using Python.
This software is available under GPL license.
Author: Clederson Cruz
Edit: Shivaen Ramshetty
Year Authored: 2017
Year Edited: 2020
...
def wins(state, player):
    ...
    win_state = [
        ...
        [state[0][5], state[1][4], state[2][3], state[3][2], state[4][1]],
        [state[1][4], state[2][3], state[3][2], state[4][1], state[5][0]],
...
def human_turn(c_choice, h_choice):
    ...
    while move < 0:
        try:
            ...
            can_move = set_move(row, col, HUMAN)
            move = 0
            if not can_move:
                print('Bad move')
                move = -1
